"""Creates the database and imports data from CSV to pandas DataFrame then from pands DataFrome to database table using sqlite3.
...
def create_db():
    ...
    # 1. Create a SQLite database engine that connects to the database file (in the current directory)
